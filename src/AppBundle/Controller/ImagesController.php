...
class ImagesController extends AbstractController
{
     ...
     * @Rest\View()
     */
    public function getImagesAction(): array
    {
     ...
     * @return View
     */
    public function postImagesAction(Image $image): View
    {
        $this->persistImage($image);

        return $this
            ->view($image, Response::HTTP_CREATED)
            ->setHeader('Location',$this->generateUrl('images_upload_put', ['image' => $image->getId()]));
    }
     ...
     * @return Response
     */
    public function putImageUploadAction(?Image $image, Request $request): Response
    {
        if (null === $image) {
