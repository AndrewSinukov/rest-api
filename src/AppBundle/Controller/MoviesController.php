...
class MoviesController extends AbstractController
{
     ...
     */
    public function getMoviesAction(Request $request): PaginatedRepresentation
    {
     ...
     * @return View|null
     */
    public function deleteMovieAction(?Movie $movie): ?View
    {
        if (null === $movie) {
     ...
     * @return PaginatedRepresentation
     */
    public function getMovieRolesAction(Request $request, Movie $movie): PaginatedRepresentation
    {
        $pageRequestFactory = new PageRequestFactory();
        $page = $pageRequestFactory->fromRequest($request);
